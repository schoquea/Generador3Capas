...
Public Class DataAccess
    ...
    Private Sub CrearClaseDataAccessCS()
        ...
        builder2.Append(""""c)
        builder2.Append("PKC_" & Me.Tabla & ".USP_" & Me.Tabla & "_SEL01")
        builder2.Append(""""c)
        builder2.Append(",con))")
        builder2.AppendLine()
        builder2.Append(Microsoft.VisualBasic.Strings.ChrW(9))
        ...
        builder2.Append("using (" & SystemData & "Command cmd = new " & SystemData & "Command(")
        builder2.Append(""""c)
        builder2.Append("PKC_" & Me.Tabla & ".USP_" & Me.Tabla & "_INS01")
        builder2.Append(""""c)
        builder2.Append(",con))")
        builder2.AppendLine()
        builder2.Append(Microsoft.VisualBasic.Strings.ChrW(9))
        ...
        builder2.Append("using (" & SystemData & "Command cmd = new " & SystemData & "Command(")
        builder2.Append(""""c)
        builder2.Append("PKC_" & Me.Tabla & ".USP_" & Me.Tabla & "_UPD01")
        builder2.Append(""""c)
        builder2.Append(",con))")
        builder2.AppendLine()
        builder2.Append(Microsoft.VisualBasic.Strings.ChrW(9))
        ...
        builder2.Append("using (" & SystemData & "Command cmd = new " & SystemData & "Command(")
        builder2.Append(""""c)
        builder2.Append("PKC_" & Me.Tabla & ".USP_" & Me.Tabla & "_DEL01")
        builder2.Append(""""c)
        builder2.Append(",con))")
        builder2.AppendLine()
        builder2.Append(Microsoft.VisualBasic.Strings.ChrW(9))
        ...
        builder2.Append("using (" & SystemData & "Command cmd = new " & SystemData & "Command(")
        builder2.Append(""""c)
        builder2.Append("PKC_" & Me.Tabla & ".USP_" & Me.Tabla & "_SEL02")
        builder2.Append(""""c)
        builder2.Append(",con))")
        builder2.AppendLine()
        builder2.Append(Microsoft.VisualBasic.Strings.ChrW(9))
